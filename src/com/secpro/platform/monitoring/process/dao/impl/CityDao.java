...
public class CityDao implements IEventMsgDao{
	private static PlatformLogger theLogger = PlatformLogger.getLogger(CityDao.class);
	@Override
	public String columnQuery(long resID, EventRuleBean eventRuleBean,
		...
		try {
			...
			String sql ="select t1."+columnName+" from sys_city t1,sys_res_obj t2 where t2.id="+resID+" and t1.city_code=t2.city_code";
