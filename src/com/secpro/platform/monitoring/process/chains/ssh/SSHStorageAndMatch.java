...
public class SSHStorageAndMatch implements IDataProcessChain{
	...
	public Object dataProcess(Object rawData) throws Exception {
		...
		String cityCode = (String) sshData
				.get(MetaDataConstant.CITY_CODE);
		String targetIP = (String) sshData
		...
		String[] sshStandardResult=(String[])sshData.get(MetaDataConstant.EXECUTE_RESULT);
		...
		String[] containAndConflictResult=policyContainAndConflict(sshStandardResult[1],loadContainAndConflictRule(cityCode,targetIP));
