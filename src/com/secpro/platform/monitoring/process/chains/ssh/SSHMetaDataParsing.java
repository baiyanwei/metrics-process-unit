...
public class SSHMetaDataParsing implements IDataProcessChain{
	private static PlatformLogger theLogger = PlatformLogger.getLogger(SSHMetaDataParsing.class);
	...
	public Object dataProcess(Object rawData) throws PlatformException{
		...
		Map<String, Object> resultData=MetaDataParsing.getTaskRelatedData(rawDataJson, "ssh");
...
//		{
//			throw new PlatformException("invalid taskCode in SSH data processing.");
//		}
		return resultData;
