...
/**
 * 基线比对
 * SSH采集回来的策略以及配置信息根据基线比对规则，与基线进行比对，并将比对结果存入数据库
 * 可产生基线比对等相应的事件
 * @author sxf
 *
 */
public class SSHMatchBaseline implements IDataProcessChain{
	private static PlatformLogger theLogger = PlatformLogger.getLogger(SSHMatchBaseline.class);
	...
	public Object dataProcess(Object rawData) throws Exception {
		...
		if(baselineValues==null){
			...
			String[] executeResult=(String[]) sshData.get(MetaDataConstant.EXECUTE_RESULT);
			int totalScore=0;
